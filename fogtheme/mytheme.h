...
public:
    ...
    {
        QString devString;
        devString = QString::fromLatin1("<p>Version %2. For more information visit <a href=\"%3\">%4</a></p> <p><small>By Serit Fjordane IT AS</small></p> <p>Copyright Serit Fjordane IT</p> <p>Licensed under the GNU General Public License (GPL) Version 2.0<br/></p>")
